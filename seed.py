...
def seed():
    ...
    permisos = [
        ...
        "contrataciones.ver", "contrataciones.crear", "contrataciones.editar", "contrataciones.eliminar",
        ...
        "carreras.ver", "carreras.crear", "carreras.editar",
        ...
        "tipos_solicitud.ver", "tipos_solicitud.crear", "tipos_solicitud.editar",
    ...
    roles_permisos_map = {
        ...
        "adm_director": [
            ...
            "modulos.ver",
            "docentes.ver",
            "contrataciones.ver", "contrataciones.editar",
            "alumnos.ver", "alumnos.editar",
            "pagos.ver",
            "documentos.revisar", "documentos.aprobar",
...
def _descripcion_permiso(codigo: str) -> str:
    descs = {
        ...
        "pagos.anular": "Anular transacciones de pago (dar de baja)",
        ...
        "carreras.editar": "Editar carreras",
        ...
        "contrataciones.eliminar": "Eliminar (truncar) contrataciones",
        "tipos_solicitud.ver": "Ver tipos de solicitud",
        "tipos_solicitud.crear": "Crear tipos de solicitud",
